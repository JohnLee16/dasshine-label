...
import { Zap, Eye, EyeOff, Lock, User, Mail, UserPlus } from 'lucide-react'
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="gradient-border p-8">
          ...
          >
            ...
            >
              <Input
                prefix={<Mail className="w-5 h-5 text-ds-text-muted" />}
                placeholder="邮箱"
                size="large"
                className="bg-ds-dark border-ds-border hover:border-ds-primary focus:border-ds-primary"
              />
            ...
            >
              <Input
                prefix={<UserPlus className="w-5 h-5 text-ds-text-muted" />}
                placeholder="昵称（可选）"
                size="large"
                className="bg-ds-dark border-ds-border hover:border-ds-primary focus:border-ds-primary"
              />
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-ds-text-muted">
              已有账号？
              <Link to="/login" className="text-ds-primary hover:text-ds-secondary transition-colors">
                立即登录
              </Link>
            </p>
          </div>
