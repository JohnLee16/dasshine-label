      ...
      >
        ...
        <div className={`absolute bottom-0 left-0 right-0 p-4 border-t border-ds-border ${collapsed ? 'hidden lg:block' : ''}`}>
          ...
          {!collapsed && (
            <button
              onClick={toggleTheme}
              className="w-full flex items-center gap-3 px-4 py-2.5 mb-3 rounded-lg text-ds-text-muted hover:text-white hover:bg-white/5 transition-all duration-200 group"
            ...
            >
              ...
              <span className="font-medium">{isDark ? '暗色模式' : '亮色模式'}</span>
            </button>
          )}
          ...
          {collapsed && (
            <button
              onClick={toggleTheme}
              className="w-full flex items-center justify-center p-2 mb-2 rounded-lg text-ds-text-muted hover:text-white hover:bg-white/5 transition-colors"
              title={isDark ? '切换到亮色模式' : '切换到暗色模式'}
            >
              <div className="relative w-5 h-5">
                <Sun 
      ...
      <main className={`flex-1 min-h-screen transition-all duration-300 ${
        ...
        <header className="h-16 bg-ds-card/50 backdrop-blur-xl border-b border-ds-border flex items-center justify-between px-6 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={toggleTheme}
              className="lg:hidden p-2 rounded-lg text-ds-text-muted hover:text-white hover:bg-white/5 transition-colors"
              title={isDark ? '切换到亮色模式' : '切换到暗色模式'}
            >
              <div className="relative w-5 h-5">
                <Sun 
